@php
    $mainCategory = \App\Http\Controllers\Controller::mainCategory();
    $cart = \App\Http\Controllers\Controller::cartItem();
@endphp
                ...
                <div class="col-md-8 clearfix">
                    <div class="shop-menu clearfix pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            @if(auth()->check())
                                <li><a href="{{ route('user.profile') }}"><i class="fa fa-lock"></i> Account</a></li>
